(defproject com.ververve/conveyare "0.5.0"
  ...
  {:dev {:dependencies [[pjstadig/humane-test-output "0.7.1"]
                        [org.apache.kafka/kafka_2.11 "0.11.0.1" :exclusions [org.slf4j/slf4j-api]]
   ...
   :test {:dependencies [[org.apache.kafka/kafka_2.11 "0.11.0.1" :exclusions [org.slf4j/slf4j-api]]
                         [org.apache.curator/curator-test "2.11.0" :exclusions [log4j]]]
          :resource-paths ["env/dev/resources"]}})
